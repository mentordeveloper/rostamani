...
namespace {
	...
	class Confide extends \Zizaco\Confide\ConfideFacade{
		...
		/**
		 * Attempt to log a user into the application without
		 * password. And only required identity field(s), usually Store Id and email or username.
		 *
		 * @param array $credentials
		 * @param bool $confirmed_only
		 * @param mixed $identity_columns
		 ...
		 * @static 
		 */
		 public static function logAttemptWithOutPassword($credentials, $confirmed_only = false, $identity_columns = array()){
			//Method inherited from \Zizaco\Confide\Confide
			return \Zizaco\Confide\Confide::logAttemptWithOutPassword($credentials, $confirmed_only, $identity_columns);
		 }
	...
	class Sentry extends \Cartalyst\Sentry\Facades\Laravel\Sentry{
		 ...
		 * @static 
		 */
		 public static function authenticate($credentials, $remember = false, $step = false){
			//Method inherited from \Cartalyst\Sentry\Sentry
			return \Cartalyst\Sentry\Sentry::authenticate($credentials, $remember, $step);
		 }
		 ...
		 * @static 
		 */
		 public static function tempLogin($user, $remember = false){
			//Method inherited from \Cartalyst\Sentry\Sentry
			 \Cartalyst\Sentry\Sentry::tempLogin($user, $remember);
		 }
		 ...
		 * @static 
		 */
		 public static function setStepValidation($step){
			//Method inherited from \Cartalyst\Sentry\Sentry
			 \Cartalyst\Sentry\Sentry::setStepValidation($step);
		 }
		 ...
		 * @static 
		 */
		 public static function getStepValidation(){
			//Method inherited from \Cartalyst\Sentry\Sentry
			return \Cartalyst\Sentry\Sentry::getStepValidation();
		 }
		 ...
		 * @static 
		 */
		 public static function setTempUser($user){
			//Method inherited from \Cartalyst\Sentry\Sentry
			 \Cartalyst\Sentry\Sentry::setTempUser($user);
		 }
		 ...
		 */
		 public static function getTempUser(){
			//Method inherited from \Cartalyst\Sentry\Sentry
			return \Cartalyst\Sentry\Sentry::getTempUser();
		 }
