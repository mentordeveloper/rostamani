                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <ul class="nav-nav-pills">
                                                ...
                                                } elseif ($errors->has('video_title') || $errors->has('video_description')) {
                                                    $vid_active = 'active';
                                                ...
                                                <li class="btn btn-default {{{$txt_active}}}">
                                                    <a onclick="txt_click('tab-text');"  href="#tab-text" data-toggle="tab" class="capt-link capt-link-1">
                                                        <i class="fa fa-file-text-o"></i><span>Slide 1 Design</span>
                                                    </a>
                                                </li>
                                                <li class="btn btn-default {{{$img_active}}}">
                                                    <a onclick="txt_click('tab-image');"  href="#tab-image" data-toggle="tab" class="capt-link capt-link-2">
                                                        <i class="fa fa-file-image-o"></i><span>Slide 2 Box Text Design</span></a>
                                                </li>
                                                <li class="btn btn-default {{{$audio_active}}}">
                                                    <a onclick="txt_click('tab-audio');" href="#tab-audio" data-toggle="tab" class="capt-link capt-link-3">
                                                        <i class="fa fa-file-audio-o"></i><span>Slide 3 Icons Design</span></a>
                                                </li>
                                                <li class="btn btn-default {{{$vid_active}}}">
                                                    <a onclick="txt_click('tab-video');" href="#tab-video" data-toggle="tab" class="capt-link capt-link-3">
                                                        <i class="fa fa-file-image-o"></i><span>Slide 4 Image Design</span></a>
                                                </li>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div style="display: {{{ $style }}};" class="tab-pane1 tab-pane {{{$active}}}" id="tab-audio">
                                            <form id="audio_frm" class="form-horizontal form-bordered form-row-stripped" method="post"
                                              action="{{{ URL::to("/sadmin/pages/postAboutCreate/".$section_id) }}}" autocomplete="off" enctype="multipart/form-data">
                                                <!-- CSRF Token -->
                                                <input type="hidden" name="_token" id="_token" value="{{{ $csrf_token }}}" />
                                                ...
                                                <!-- ./ name -->
                                                <!-- description -->
                                                <div class="hidden form-group {{{ $errors->has('audio_description') ? 'has-error' : '' }}}">
                                                                ...
                                                                <div class="portlet gray">
                                                                    ...
                                                                    <div class="portlet-body">
                                                                        <div class="form-group {{{ $errors->has("icon$i") ? 'has-error' : '' }}}">
                                                                            <div class="col-md-12">
                                                                                <input  placeholder="Icon <?php echo $i; ?> Title" class="form-control" type="text" name="icon<?php echo $i;?>" id="icon<?php echo $i;?>" value="{{{ Input::old('icon') }}}" />
                                        ...
                                        <div style="display: {{{ $style }}};" class="tab-pane1 tab-pane  {{{$active}}}" id="tab-video">
                                            <form id="video_frm" class="form-horizontal form-bordered form-row-stripped" method="post"
                                                ...
                                                <!-- Status -->
                                                <?php if ($option == 1) { ?>
                                                    <div class="hidden form-group {{{ $errors->has('video_category_list') ? 'has-error' : '' }}}">
                                        ...
                                        <div style="display: {{{ $style}}};" class="tab-pane1 tab-pane  {{{$active}}}" id="tab-image">
                                            <form id="img_frm" class="form-horizontal form-bordered form-row-stripped" method="post" 
                                                ...
                                                <div class="form-group {{{ $errors->has('img_title') ? 'has-error' : '' }}}">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input required="" placeholder="Tittle"  class="form-control" type="text" name="img_title" id="img_title" value="{{{ Input::old('img_title') }}}" />
                                                ...
                                                <div class="form-group {{{ $errors->has('img_description') ? 'has-error' : '' }}}">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea required="" class="form-control full-width wysihtml5" name="img_description" id="img_description" rows="5">{{{ Input::old('img_description', isset($post) ? $post->description : null) }}}</textarea>
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-8 well">
                                                                ...
                                                                <div class="portlet gray">
                                                                    ...
                                                                    <div class="portlet-body">
                                                                        <div class="form-group">
                                                                            <div class="col-md-12">
                                                                                <input required="" placeholder="Box <?php echo $i; ?> Title" class="form-control" type="text" name="box<?php echo $i; ?>" id="box<?php echo $i; ?>" value="" />
                                                                            </div>
                                                                            <div class="col-md-12">
                                                                                <textarea required=""  placeholder="Box <?php echo $i; ?> Description"  class="form-control full-width" name="box_msg_<?php echo $i; ?>" id="box_msg<?php echo $i; ?>" rows="1" cols="10"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div style="display: {{{$style}}};" class="tab-pane1 tab-pane  {{{$active}}}" id="tab-text">
                                            <form id="doc_frm" class="form-horizontal form-bordered form-row-stripped" method="post" 
                                                ...
                                                <div class="form-group {{{ $errors->has('txt_title') ? 'has-error' : '' }}}">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input required="" placeholder="Title" class="form-control" type="text" name="txt_title" id="txt_title" value="{{{ Input::old('txt_title') }}}" />
                                                ...
                                                <div class="form-group {{{ $errors->has('txt_name') ? 'has-error' : '' }}}">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input placeholder="Owner Name" class="form-control" type="text" name="txt_name" id="txt_name" value="{{{ Input::old('txt_name') }}}" />
                                                ...
                                                <div class="form-group {{{ $errors->has('description') ? 'has-error' : '' }}}">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea required="" class="form-control full-width wysihtml5" name="description" id="description" rows="10">{{{ Input::old('description') }}}</textarea>
