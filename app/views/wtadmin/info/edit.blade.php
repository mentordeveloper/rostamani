    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group {{{ $errors->has('api_username') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="api_username" id="api_username" value="{{{ $info->api_username }}}" />
            ...
            <div class="form-group {{{ $errors->has('api_secret') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="api_secret" id="api_secret" value="{{{ $info->api_secret }}}" />
            ...
            <div style="display: none;" class="form-group {{{ $errors->has('tax_rate') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="tax_rate" id="tax_rate" value="{{{ $info->tax_rate}}}" />
            ...
            <div class="form-group {{{ $errors->has('is_sandbox') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <select class="form-control"  name="is_sandbox" id="is_sandbox">
                        <option value="1" {{{ ($info->is_sandbox == 1) ? 'selected=""' : ''}}}>Sandbox</option>
                        <option value="2" {{{ ($info->is_sandbox == 2) ? 'selected=""' : ''}}}>Production</option>
                    </select>
