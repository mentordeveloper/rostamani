...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="tab-general">
        {{-- Create User Form --}}
        <form name="import_user_frm" id="import_user_frm" class="form-horizontal" method="post" action="@if (isset($user)){{ URL::to('wtadmin/users/import') }}@endif" autocomplete="off">
            <!-- CSRF Token -->
            ...
            <div class="form-group {{{ $errors->has('upload_path') ? 'error' : '' }}}">
                <label class="col-md-2 control-label" for="upload_path">Users Import</label>
                <div class="col-md-10">
    ...
    <div class="tab-pane" id="tab-demo">
        ...
        <div class="form-group {{{ $errors->has('upload_path') ? 'error' : '' }}}">
            ...
            <div class="col-md-10">
                <a href="/user_import.csv">Import Pattern</a>
            </div>
        </div>
