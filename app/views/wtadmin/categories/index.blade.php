...
<div class="page-header">
		<h3>
			...
			<div class="pull-right">
                 <a href="{{{ URL::to('sadmin/categories/create') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
               </div>
		</h3>
	</div>
<ol class="breadcrumb">
...
<table id="categories" class="table table-bordered table-striped table-hover">
  <thead>
			<tr>
                   ...
                   <th class="col-md-2">{{{ Lang::get('wtadmin/categories/table.entries') }}}</th>
                   <th class="col-md-2">{{{ Lang::get('wtadmin/categories/table.created_at') }}}</th>
                 <th class="col-md-2">{{{ Lang::get('wtadmin/categories/table.content') }}}</th>
...
@section('scripts')
	<script type="text/javascript">
		...
		$(document).ready(function() {
				...
				"bProcessing": true,
		        "bServerSide": true,
		        "sAjaxSource": "{{ URL::to('sadmin/categories/data') }}",
