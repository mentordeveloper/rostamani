    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group {{{ $errors->has('parent_category') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    ...
                    <select class="form-control"  name="parent_category" id="parent_cate">
                        ...
                        <option value="{{{ $cate->id }}}" {{{ (Input::old('parent_category')==$cate->id )?"selected=''":"" }}}>{{{ $cate->cat_name }}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group {{{ $errors->has('sub_category') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    ...
                    <select class="form-control"  name="sub_category" id="sub_cate">
                        ...
                        <option value="{{{ $sub_cate->id }}}" {{{ (Input::old('sub_category')==$sub_cate->id )?"selected=''":"" }}}>{{{ $sub_cate->cat_name }}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group {{{ $errors->has('lumen') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" placeholder="Lumen or Electrical Product Link" type="text" name="lumen" id="lumen" value="{{{ Input::old('lumen') }}}" />
            ...
            <div class="form-group {{{ $errors->has('beam_angle') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="beam_angle" id="beam_angle" value="{{{ Input::old('beam_angle') }}}" />
            ...
            <div class="form-group {{{ $errors->has('move_angle') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="move_angle" id="move_angle" value="{{{ Input::old('move_angle') }}}" />
            ...
            <div class="form-group {{{ $errors->has('body_size') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="body_size" id="body_size" value="{{{ Input::old('body_size') }}}" />
            ...
            <div class="form-group {{{ $errors->has('hole_size') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="hole_size" id="hole_size" value="{{{ Input::old('hole_size') }}}" />
            ...
            <div class="form-group {{{ $errors->has('material') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="material" id="material" value="{{{ Input::old('material') }}}" />
            ...
            <div class="form-group {{{ $errors->has('color') ? 'error' : '' }}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" name="color" id="color" value="{{{ Input::old('color') }}}" />
            ...
            <div class="form-group {{{ $errors->has('short_description') ? 'has-error' : '' }}}">
                ...
                <div class="col-md-10">
                    <textarea class="form-control full-width wysihtml5" name="short_description" id="short_description" rows="5">{{{ Input::old('short_description', isset($post) ? $post->description : null) }}}</textarea>
