...
<ol class="breadcrumb">
    ...
    <!-- ./ tabs -->
    {{-- Delete Post Form --}}
    <form id="deleteForm" class="form-horizontal" method="post" action="@if (isset($permission)){{ URL::to('wtadmin/permissions/' . $permission->id . '/delete') }}@endif" autocomplete="off">
