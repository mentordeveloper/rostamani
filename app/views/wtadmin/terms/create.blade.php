     ...
     <form class="form-horizontal" method="post" action="" autocomplete="off">
                    ...
                    <div class="col-md-10">
                        <select class="form-control" name="day_name" id="day_name">
                            ...
                            @foreach($remain_days as $days)
                               <option value="{{{$days}}}" {{{ (Input::old('day_name')==$days)?'selected=""':'' }}}>{{{$days}}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group {{{ $errors->has('start_time') || $errors->has('from_time') ? 'error' : '' }}}">
                        ...
                        <div class="col-md-10">
                            <div class="bootstrap-timepicker">
                                <input id="timepicker3" name="start_time" value="{{{ Input::old('start_time') }}}"  type="text" class="form-control">
                            </div>
                        ...
                        <div class="form-group {{{ $errors->has('end_time') ? 'error' : '' }}}">
                            ...
                            <div class="col-md-10">
                                <div class="bootstrap-timepicker">
                                    <input id="timepicker2" name="end_time" value="{{{ Input::old('end_time') }}}"  type="text" class="form-control">
                                </div>
		...
		<div class="form-group">
            <div class="col-md-offset-2 col-md-10">
              ...
              <button type="submit" class="btn btn-success">Create Time</button>
            </div>
		</div>
		<!-- ./ form actions -->
	</form>
