                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top">
                                                                                        <div style="font-size:12px;font-family:Helvetica Neue,arial,helvetica,freesans,sans-serif;color:#575756;">
                                                                                            ...
                                                                                            <p><b>{{ Lang::get('confide::confide.email.password_reset.greetings', array( 'name' => $user->username)) }},</b></p>

                                                                                            <p>{{ Lang::get('confide::confide.email.password_reset.body') }}</p>
                                                                                            <a href='{{{ (Confide::checkAction('UserController@reset_password', array($params['token']))) ? : URL::to('user/reset/'.$params['token'])  }}}'>
                                                                                                {{{ (Confide::checkAction('UserController@reset_password', array($params['token']))) ? : URL::to('user/reset/'.$params['token'])  }}}
                                                                                            </a>
