                                                                ...
                                                                <tr>
                                                                    <td style="padding:20px;"><table border="0" cellpadding="0" cellspacing="0">
                                                                            <tbody style="padding:0;">
                                                                                ...
                                                                                <tr>
                                                                                    <td> <table border="0" cellpadding="0" cellspacing="0" width="100%" id="ecxemail_body">
                                                                                            <tbody style="padding:0;">
                                                                                                <tr>
                                                                                                    <td style="padding:20px;"><table border="0" cellpadding="0" cellspacing="0">
                                                                                                            <tbody style="padding:0;">
                                                                                                                <tr>
                                                                                                                    <td valign="top">
                                                                                                                        <div style="font-size:12px;font-family:Helvetica Neue,arial,helvetica,freesans,sans-serif;color:#575756;">
                                                                                                                            ...
                                                                                                                            <p>{{ Lang::get('confide::confide.email.store_account_confirmation.body') }}</p>
                                                                                                                            <a href='{{{ URL::to("store/confirm/{$user['store_hash']}/{$user['store_id']}") }}}'>
                                                                                                                                {{{ URL::to("store/confirm/{$user['store_hash']}/{$user['store_id']}") }}}
                                                                                                                            </a>
