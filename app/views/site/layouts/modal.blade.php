...
<html lang="en">
  ...
  <head id="Starter-Site">
    ...
    <meta name="DC.title" content="Datasnap: Elearning Management System.">
              ...
              <div class="page-header">
                  <h3>
                      ...
                      <div class="pull-right">
                          <a href="javascript:history.back(-1);" class="btn btn-default btn-small btn-inverse close_popup"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
                      </div>
                  </h3>
              </div>
              <!-- Content -->
