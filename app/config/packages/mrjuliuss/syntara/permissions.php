...
return array(
        ...
        'manage_feature' => 'm_d_features',
        'store_view' => 'm_s_view',
        'listSize' => 'view-size-list',
        'deletelistSize' => 'delete-size',
        'newlistSize' => 'create-size',
        'newlistSizePost' => 'create-size',
        'showlistSize' => 'update-size-info',
        'putlistSize' => 'update-size-info',
        'putActivatelistSize' => 'update-size-info',
        'listCate' => 'view-cate-list',
        'deletelistCate' => 'delete-cate',
        'newlistCate' => 'create-cate',
        'newlistCatePost' => 'create-cate',
        'showlistCate' => 'update-cate-info',
        'putlistCate' => 'update-cate-info',
        'putActivatelistCate' => 'update-cate-info',
